        ...
        <MainTemplate variant={'primary'} Remove100VhAttribute>
            <div style={{padding: '3rem'}}>
                {process.env.NODE_ENV === 'development' ?
                    <small>This Application is running in <b style={{
                        color: 'red',
                        textTransform: 'uppercase'
                    }}>{process.env.NODE_ENV}</b> mode.</small> : null
                }
                ...
                <p>
                    <a href="https://github.com/KristofaJosh/MyReactBoilerPlate.git" rel="noopener noreferrer"
                       target={'_blank'}>Pull features </a>
                ...
                <div style={{marginTop: '4rem'}}>
                    ...
                    <br/>
                    <button style={{backgroundColor: backgroundColor}} onClick={changeStyle.changeMode}>Change Theme
                        Mode
                    </button>
                    <br/>
                    {
                        isAuth ?
                            (
                                <button onClick={() => dispatch(isAuthenticated())}>Logout</button>
                            )
                            : null
                    }
                </div>
